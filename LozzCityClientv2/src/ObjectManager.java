...
final class ObjectManager {
	...
	private void method175(int i, WorldController worldController, Class11 class11, int j, int k, int l, int i1, int j1) {
		...
		/**
		 * Removing any kind of objects, such as walls/decorations etc.
		 */
		int mX = Client.instance.anInt1069 - 6;
		int mY = Client.instance.anInt1070 - 6;
		int actualX = mX * 8 + l;
		int actualY = mY * 8 + i;
		int actualH = k;
		
		//edgevillemenhouse
				if(actualX < 3091|| actualY < 3507 || actualX > 3100 || actualY > 3513) {
						//3100-3513
					//3091-3507
		//Deleting edgeville "man-house" wall
		if(actualH == 0) {
			if(actualX >= 3092 && actualX <= 3094 && (actualY == 3514 || actualY == 3513 || actualY == 3506 
					|| actualY == 3505 || actualY == 3507)) {
				return;
			}
		}
