...
public class CustomInterfaces extends RSInterface {
	...
	public static void unpackInterfaces(TextDrawingArea[] Mayhem) {
		...
		/*
		 * Handles teleporting to various locations around LozzCity
		 */
		...
		/*
		 * Handles the bucks system for LozzCity
		 */
		creditsTab(Mayhem);
	...
	public static void settings(TextDrawingArea[] tda) {
		...
		addText(28506, "Customize LozzCity to your likings.", tda, 1, 0xFF981F, true, true);
	...
	public static void questTab(TextDrawingArea tda[]) {
		...
		addText(29406, "www.LozzCity.com", tda, 0, 0xF7AA25, true, true);
	...
	public static void weaponStore(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(56500);
		addSprite(56501, 462);
		addText(56502, "Weapon Game Reward Store", Rum, 2, 0xff9933, true, true);
		itemContainer(56503, 28, 8, 6, 50, false, "Select", "Buy");
		addText(56504, "Welcome to the Weapon Game Rewards store!", Rum, 0, 0xff9933, true, true);
		addText(56505, "", Rum, 0, 0xff9933, true, true);
		addText(56506, "", Rum, 0, 0xff9933, false, true);
		addText(56507, "", Rum, 0, 0xff9933, false, true);
		itemContainer(56508, 28, 8, 20, 50, false);
		addText(56509, "", Rum, 0, 0xff9933, false, true);
	...
	public static void bankPin(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(48750);
		addSprite(48751, 461);
		addText(48752, "Bank Pin", Rum, 2, 0xff9933, true, true);
		addText(48753, "You need to enter your bank pin", Rum, 1, 0xff9933, true, true);
		addText(48754, "before accessing this!", Rum, 1, 0xff9933, true, true);
		addInputField(48750, 48755, 4, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 150, 23, false, false, "");
		addHoverText(48756, "Close window", "Close window", Rum, 1, 0xF7AA25, false, true, 250);	
		tab.totalChildren(6);
	...
	public static void accountManager(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(56000);
		addSprite(56001, 460);
		addHoverButton(56002, 17, 21, 21, "Close", 250, 56003, 3);
		addHoveredButton(56003, 18, 21, 21, 56004);	
		addText(56005, "Account Security Management", Rum, 2, 0xff9933, true, true);
		addText(56006, "Please answer the following prompts to ensure a safe account.", Rum, 0, 0xff9933, true, true);
		addText(56007, "Having a safe account is crucial in the world of Mayhem.", Rum, 0, 0xff9933, true, true);
		addText(56008, "Make sure to write all this information down!", Rum, 0, 0xff9933, true, true);
		addText(56009, "Full Name", Rum, 2, 0xff9933, true, true);
		addText(56010, "Email Address:", Rum, 2, 0xff9933, true, true);
		addText(56011, "Recovery Answer:", Rum, 2, 0xff9933, true, true);
		addText(56012, "IP Address:", Rum, 2, 0xff9933, true, true);
		...
		addText(56017, "@red@Once you set your information it cannot be changed!", Rum, 0, 0xff9933, true, true);
	...
	public static void ticketInterface(TextDrawingArea[] Rum) {
		RSInterface boob = addInterface(51250);
		addSprite(51251, 463);
		addText(51252, "Ticket Manager", Rum, 2, 0xff9933, true, true);
		...
		addText(51256, "Title:", Rum, 3, 0xff9933, true, true);
		addText(51257, "Issue:", Rum, 3, 0xff9933, true, true);
		...
		addText(51263, "Send", Rum, 3, 0xff9933, true, true);
	...
	public static void bankPinManager(TextDrawingArea[] Rum) {
		RSInterface boob = addInterface(43750);
		addSprite(43751, 459);
		addText(43752, "Bank Pin Management", Rum, 2, 0xff9933, true, true);
		addText(43753, "</col>Bank pin status: @red@None!", Rum, 0, 0xff9933, true, true);
		addText(43754, "Type in a 4 digit number and press enter to set a pin.", Rum, 0, 0xff9933, true, true);
		addInputField(43750, 43755, 4, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 100, 23, false, false, "");
		addText(43756, "Be sure to write this down!", Rum, 0, 0xff9933, true, true);
	...
	public static void weaponLobby(TextDrawingArea[] Rum) {
		RSInterface boob = addInterface(41250);
		addSprite(41251, 453);
		addText(41252, "Players ready: 0", Rum, 0, 0x33cc00, false, true);
		addText(41253, "(Need 5 to 20)", Rum, 0, 0xFFcc33, false, true);
		addText(41254, "Next Departure: 60 sec", Rum, 0, 0x33ccff, false, true);
	...
	public static void weaponGame(TextDrawingArea[] Rum) {
		RSInterface boob = addInterface(41270);
		addTransparentSprite(41271, 452);
		addText(41272, "Weapon Game", Rum, 2, 0xff9933, true, true);
		addText(41273, "Time Left:", Rum, 0, 0xff9933, false, true);
		addText(41274, "5:30", Rum, 0, 0xFFFFFF, false, true);		
		addText(41275, "Players:", Rum, 0, 0xff9933, false, true);
		addText(41276, "7", Rum, 0, 0xFFFFFF, false, true);	
		addText(41277, "Leader:", Rum, 0, 0xff9933, false, true);
		addText(41278, "Rum", Rum, 0, 0xFFFFFF, false, true);	
		addText(41279, "Crates:", Rum, 0, 0xff9933, false, true);
		addText(41280, "0:14", Rum, 0, 0xFFFFFF, false, true);	
		addText(41281, "Tier:", Rum, 0, 0xff9933, false, true);
		addText(41282, "5", Rum, 0, 0xFFFFFF, false, true);
		itemContainer(41283, 45, 8, 20, 50, true);
		
		addText(41284, "Current", Rum, 0, 0xff9933, false, true);
		addText(41285, "Next", Rum, 0, 0xff9933, false, true);
	...
	public static void boltEnchanting(TextDrawingArea[] Rum) {
		...
		addText(42756, "Magic 4", Rum, 1, 0xff9933, true, true);
		addText(42757, "Magic 7", Rum, 1, 0xff9933, true, true);
		addText(42758, "Magic 14", Rum, 1, 0xff9933, true, true);
		addText(42759, "Magic 24", Rum, 1, 0xff9933, true, true);
		addText(42760, "Magic 27", Rum, 1, 0xff9933, true, true);
		addText(42761, "Magic 29", Rum, 1, 0xff9933, true, true);
		addText(42762, "Magic 49", Rum, 1, 0xff9933, true, true);
		addText(42763, "Magic 57", Rum, 1, 0xff9933, true, true);
		addText(42764, "Magic 68", Rum, 1, 0xff9933, true, true);
		addText(42765, "Magic 87", Rum, 1, 0xff9933, true, true);
		addText(42766, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42767, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42768, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42769, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42770, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42771, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42772, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42773, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42774, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42775, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42776, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42777, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42778, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42779, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42780, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42781, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42782, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42783, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42784, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42785, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42786, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42787, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42788, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42789, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42790, "0/0", Rum, 0, 0xFA0A0A, true, true);
		addText(42791, "0/0", Rum, 0, 0xFA0A0A, true, true);
	...
	public static void reportAbuse(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(41750);
		addSprite(41751, 449);
		addHoverButton(41752, 17, 21, 21, "Close", 250, 41753, 3);
		addHoveredButton(41753, 18, 21, 21, 41754);
		addText(41755, "Report Abuse", Rum, 2, 0xff9933, true, true);
		
		addText(41756, "This form is for reporting players who are breaking our rules.", Rum, 1, 0xff9933, true, true);
		addText(41757, "Using it sends a snapshot of the last 60 seconds of activity to us.", Rum, 1, 0xff9933, true, true);
		addText(41758, "Misusing this form will result with an infraction, or worse.", Rum, 1, 0xDB0D0D, true, true);
		addText(41759, "Please enter the username of the offending player:", Rum, 1, 0xff9933, true, true);
		
		addInputField(41750, 41760, 25, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 180, 23, false, false, "");
		
		addText(41761, "Please select the rule of which the offending player has broken.", Rum, 1, 0xff9933, true, true);
		
		String[] rules = { 
			"Offensive language", "Item scamming", "Password scamming", "Bug abuse",
			"LozzCity staff impersonation", "Account sharing/trading", "Macroing", "Multiple logging in",
			"Advertising", "Real world trading", "Misuse of customer support", "Encouraging others to break rules",
		};
		
		for (int i = 0; i < rules.length; i ++) {
			addHoverText(41762 + i, (i + 1) + ") " + rules[i], "Select", Rum, 0, 0xF7AA25, false, true, 250);	
		}
	...
	public static String[][][] shopContent = new String[][][] {
		...
		{ 
			...
			{ "The Killer", "50 Kills" }, 
			{ "Bone Crusher", "1000 Bones" }, 
			{ "Gold Digger", "1000 Rocks" }, 
			{ "Dead", "50 deaths" }, 
			{ "Crystal", "1000 Rocks" }, 
			{ "Gordon Ramsay", "1k Food" }, 
			{ "Pyroman", "1250 Logs" }, 
			{ "Rich Kid", "100m Spent" }, 
			//{ "Trivial", "80 triviabot" }, 
		...
		/** Colors */
		{ 
			{ "<col=ff0000>Red", "@whi@25,000.000" }, 
			{ "<col=00ff00>Green", "@whi@25,000.000" }, 
			{ "<col=00fff7>Cyan", "@whi@25,000.000" },
			{ "<col=e8e401>Yellow", "@whi@25,000.000" },
			{ "<col=ff9300>Orange", "@whi@25,000.000" },
			{ "<col=a600ff>Purple", "@whi@25,000.000" },
			{ "<col=F52CD7>Pink", "@whi@25,000.000" },
			{ "<col=FFFFFF>White", "@whi@25,000.000" }, 
		} 
	};
	...
	public static void fireColor(TextDrawingArea[] Mayhem) {
		...
		addText(49756, "By paying 10 LozzCity Bucks you can change all fire colors.", 0xff9933, true, true, -1, Mayhem, 0);
		...
		addText(49759, "Changed by: Rum", 0xff9933, true, true, -1, Mayhem, 0);
		addText(49760, "Rum's Clan: LozzCity", 0xff9933, true, true, -1, Mayhem, 0);
	...
	public static void starter(TextDrawingArea[] Rum) {
		RSInterface Interface = addInterface(51750);
		
		addSprite(51751, 431);
		addText(51752, "LozzCity Account Setup", 0xff9933, true, true, 52, Rum, 2);
		addHoverButton(51753, 17, 21, 21, "Close", 250, 51754, 3);
		addHoveredButton(51754, 18, 21, 21, 51755);
		addText(51756, "Select Your Game Mode:", 0xff9933, true, true, 52, Rum, 1);
		addText(51757, "Starter Items:", 0xff9933, false, true, 52, Rum, 1);
		itemDisplay(51758, 7, 15, 8, 3);
		addText(51759, "Mode Description:", 0xff9933, true, true, 52, Rum, 2);
		addText(51760, "Line 1", 0xff9933, true, true, 52, Rum, 0);
		addText(51761, "Line 2", 0xff9933, true, true, 52, Rum, 0);
		addText(51762, "Line 3", 0xff9933, true, true, 52, Rum, 0);
		...
		addHoverText(51766,"Normal", "Select Normal", Rum, 0, 0xF7AA25, false, true, 250);
		addHoverText(51767,"Iron Man", "Select Iron Man", Rum, 0, 0xF7AA25, false, true, 250);
		addHoverText(51768,"Ultimate Iron Man", "Select Ultimate Iron Man", Rum, 0, 0xF7AA25, false, true, 250);
	...
	public static void inPvP(TextDrawingArea[] Rum) {
		...
		addText(60253, "@or1@116 - 126", 0x000000, true, true, 52, Rum, 0);
		addText(60254, "@or1@- - -", 0x000000, true, true, 52, Rum, 0);
	...
	public static void godWars(TextDrawingArea[] Rum) {
		int ID = 61750;
		RSInterface Interface = addInterface(ID);
		addText(ID + 1, "NPC Killcount", 0xEDE026, false, true, 52, Rum, 0);
		String[] TEXTS = { "Armadyl", "Bandos", "Saradomin", "Zamorak" };
		for (int index = 0; index < 4; index++) {
			addText(ID + (2 + index), TEXTS[index] + " kills", 0xff9040, false, true, 52, Rum, 0);
		}
		for (int index = 0; index < 4; index++) {
			addText(ID + (6 + index), "0", 0x54BFE3, false, true, 52, Rum, 0);
		}
	...
	public static void inSafe(TextDrawingArea[] Rum) {
	...
	public static void inTimer(TextDrawingArea[] Rum) {
		RSInterface Interface = addInterface(60450);
		addSprite(60451, 424);
		addTooltipBox(60452, "You currently have a PvP timer.");
		addText(60453, "@whi@10", 0x000000, true, true, 52, Rum, 3);
	...
	public static void PKSkillTab(TextDrawingArea[] Rum) {
		RSInterface Interface = addInterface(63700);
		addSprite(63701, 71);
		String[] levels = { "Attack", "Defence", "Strength", "Hitpoints", "Ranged", "Prayer", "Magic", "Bounty" };
		for (int i = 0; i < 8; i ++) {
			addText(63702 + i, "@or1@" + levels[i], 0x000000, false, true, 52, Rum, 2);
		}
		for (int i = 0; i < 8; i ++) {
			addText(63720 + i, "@or2@99/99", 0x000000, false, true, 52, Rum, 1);
		}
	...
	public static void loyaltyShop(TextDrawingArea[] tda) {
		...
		addSprite(id + 6, 407);
		addText(id + 7, "LozzCity Bucks", tda, 0, 0xe6be78, false, true);
		addText(id + 8, "Welcome to the LozzCity title shop.", tda, 0, 0xe6be78, false, true);
	...
	public static void bankSettings(TextDrawingArea[] Mayhem) {
		...
		addSprite(32501, 368);
		addText(32502, "LozzCity Bank Settings", 0xff9933, true, true, -1, Mayhem, 2);
	...
	public static void profileLeaderboards(TextDrawingArea[] Rum) {
		...
		addText(47418, "Views", Rum, 2, 0xF7AA25, true, true);	
		addText(47419, "Likes", Rum, 2, 0xF7AA25, true, true);	
		addText(47420, "Dislikes", Rum, 2, 0xF7AA25, true, true);	
		addText(47421, "Ratio", Rum, 2, 0xF7AA25, true, true);	
		...
		int y = 0;
		for (int i = 0; i < 25; i++) {
			addHoverText(51551 + i, "Username", "View", Rum, 0, 0xcc8000, true, true, 100, 0xFFFFFF);
			setBounds(51551 + i, 0, y, i, scrollInterface);
			y += 20;
		}
	}
	
	/*public static void settings(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(28400);
		
		addSprite(28401, 360);
		addSprite(28402, 38);
		addText(28403, "Settings", Rum, 2, 0xF7AA25, true, true);
		addText(28404, "Customize your game play!", Rum, 0, 0xF7AA25, true, true);		
		...
		for (int i = 0; i < amount; i++) {		
			...
			addText(28450 + i, "", Rum, 0, 0xF7AA25, false, true);
	...
	*/
	...
	public static void staffTab(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(49700);			
		addSprite(49701, 360);
		addSprite(49702, 38);
		addText(49703, "Staff Tab", Rum, 2, 0xF7AA25, true, true);
		addText(49704, "You have access to all commands!", Rum, 0, 0xF7AA25, true, true);
		addText(49705, "</col>Rank: @red@<img=2> Owner", Rum, 0, 0xF7AA25, true, true);
		addHoverText(49706, "> Back to Quest Tab <", "Go back", Rum, 0, 0xF7AA25, true, true, 60);
	 ...
	 * @param Rum
	 */
	public static void profileTab(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(51500);			
		addSprite(51501, 360);
		addSprite(51502, 38);
		addText(51503, "Player Profiler", Rum, 2, 0xF7AA25, true, true);
		...
		addHoverText(51509, "Enable Privacy", "Enable", Rum, 0, 0xF7AA25, false, true, 60);
		addHoverText(51510, "Disable Privacy", "Disable", Rum, 0, 0xF7AA25, false, true, 60);	
		addHoverButton(51511, 36, 150, 35, "View my profile", 0, 51512, 1);
		addHoveredButton(51512, 37, 150, 35, 51513);
		addText(51514, "My Profile", Rum, 2, 0xF7AA25, true, true);	
		addHoverButton(51515, 36, 150, 35, "View profile leaderboards", 0, 51516, 1);
		addHoveredButton(51516, 37, 150, 35, 51517);
		addText(51518, "Leaderboards", Rum, 2, 0xF7AA25, true, true);	
	 ...
	 * @param Rum
	 */
	public static void myProfile(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(51600);	
		addSprite(51601, 359);
		addText(51602, "My Profile", Rum, 2, 0xff981f, true, true);
		addHoverButton(51603, 17, 21, 21, "Close", 250, 51604, 3);
		addHoveredButton(51604, 18, 21, 21, 51605);
		addChar(51606, 700);
		addText(51607, "</col>Name: @gre@Rum", Rum, 1, 0xff981f, true, true);
		addText(51608, "</col>Rank: @cr2@@gre@  Owner", Rum, 1, 0xff981f, true, true);
		addText(51609, "</col>Level: @gre@126", Rum, 1, 0xff981f, true, true);
		for (int i = 0; i < 21; i++) {
		...
		int y = 0;
		for (int i = 0; i < 35; i++) {
			addHoverText(51681 + i, "" , "", Rum, 0, 0xff981f, true, true, 160, 0xff981f);
	 ...
	 * @param Rum
	 */
	public static void playerProfiler(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(51800);	
		addSprite(51801, 359);
		addText(51802, "Player Profiler", Rum, 2, 0xff981f, true, true);
		addHoverButton(51803, 17, 21, 21, "Close", 250, 51804, 3);
		addHoveredButton(51804, 18, 21, 21, 51805);
		addOtherChar(51806, 700);
		addText(51807, "</col>Name: @gre@Rum", Rum, 1, 0xff981f, true, true);
		addText(51808, "</col>Rank: @cr2@@gre@  Owner", Rum, 1, 0xff981f, true, true);
		addText(51809, "</col>Level: @gre@126", Rum, 1, 0xff981f, true, true);
		for (int i = 0; i < 21; i++) {
		...
		int y = 0;
		for (int i = 0; i < 35; i++) {
			addHoverText(51881 + i, "" , "", Rum, 0, 0xff981f, true, true, 160, 0xff981f);
	 ...
	 * @param Rum
	 */
	public static void warriorGuild(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(51200);	
		addText(51202, "Warrior's Guild", Rum, 2, 0xff981f, true, true);
		itemDisplay(51203, 30, 30, 4, 5);
		addText(51204, "Dropping:", Rum, 0, 0xff981f, true, true);
		addText(51205, "Tokens Used:", Rum, 0, 0xff981f, true, true);
		addText(51206, "Cyclops Killed:", Rum, 0, 0xff981f, true, true);	
		tab.totalChildren(5);
	 ...
	 * @param Rum
	 */
	public static void prestige(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(51000);
		addSprite(51001, 301);
		addChar(51002, 560);
		addHoverButton(51003, 17, 21, 21, "Close", 250, 51004, 3);
		addHoveredButton(51004, 18, 21, 21, 51005);
		addText(51006, "Prestige Panel", Rum, 2, 0xff981f, false, true);
		addText(51007, "Rum", Rum, 1, 0xff981f, true, true);
		addText(51008, "Total Prestige(s): 0", Rum, 1, 0xff981f, true, true);
		addText(51009, "Prestige Pnt(s): 0", Rum, 1, 0xff981f, true, true);
		addText(51010, "Attack (0)", Rum, 0, 0xff981f, true, true);
		addText(51011, "Strength (0)", Rum, 0, 0xff981f, true, true);
		addText(51012, "Defence (0)", Rum, 0, 0xff981f, true, true);
		addText(51013, "Ranged (0)", Rum, 0, 0xff981f, true, true);
		addText(51014, "Prayer (0)", Rum, 0, 0xff981f, true, true);
		addText(51015, "Magic (0)", Rum, 0, 0xff981f, true, true);
		addText(51016, "RC (0)", Rum, 0, 0xff981f, true, true);
		addText(51017, "Hitpoints (0)", Rum, 0, 0xff981f, true, true);
		addText(51018, "Agility (0)", Rum, 0, 0xff981f, true, true);
		addText(51019, "Herblore (0)", Rum, 0, 0xff981f, true, true);
		addText(51020, "Thieving (0)", Rum, 0, 0xff981f, true, true);
		addText(51021, "Crafting (0)", Rum, 0, 0xff981f, true, true);
		addText(51022, "Fletching (0)", Rum, 0, 0xff981f, true, true);
		addText(51023, "Slayer (0)", Rum, 0, 0xff981f, true, true);	
		addText(51024, "Mining (0)", Rum, 0, 0xff981f, true, true);
		addText(51025, "Smithing (0)", Rum, 0, 0xff981f, true, true);
		addText(51026, "Fishing (0)", Rum, 0, 0xff981f, true, true);
		addText(51027, "Cooking (0)", Rum, 0, 0xff981f, true, true);
		addText(51028, "Firemaking (0)", Rum, 0, 0xff981f, true, true);
		addText(51029, "Woodcutting (0)", Rum, 0, 0xff981f, true, true);
		addText(51030, "Farming (0)", Rum, 0, 0xff981f, true, true);
		addText(51031, "Hunter (0)", Rum, 0, 0xff981f, true, true);		
	...
	public static void friendsTab(TextDrawingArea[] tda) {
		...
		addText(5070, "   LozzCity", tda, 0, 0xff9933, false, true);
	...
	public static void ignoreTab(TextDrawingArea[] tda) {
		...
		addText(5720, "   LozzCity", tda, 0, 0xff9933, false, true);
	...
	public static void expCounter(TextDrawingArea[] Rum) {
		...
		addText(32809, "Normal", 0xff9933, false, true, -1, Rum, 1);
		addText(32810, "Sideways", 0xff9933, false, true, -1, Rum, 1);
		addText(32811, "Scrambled", 0xff9933, false, true, -1, Rum, 1);
		tab.totalChildren(10);
	 ...
	 * @param Rum
	 */
	public static void chatColor(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(37500);
		addSprite(37501, 261);
		addHoverButton(37502, 17, 21, 21, "Close", 250, 37503, 3);
		addHoveredButton(37503, 18, 21, 21, 37504);
		addText(37505, "Private Chat Color Changer", 0xff9933, true, true, -1, Rum, 3);
		addText(37506, "Chosen color: ", 0xff9933, true, true, -1, Rum, 1);
	 ...
	 * @param Rum
	 */
	public static void mysteryBox(TextDrawingArea[] Rum) {
		RSInterface rsinterface = addTabInterface(17000);
		addSprite(17001, 257);
		lotteryItem(17002);
		mysteryWonItem(17007);
		addText(17003, "Mystery Box ", Rum, 2, 0xF7AA25, true, true);
		addHoverButton(17004, 258, 146, 37, "Bet LozzCity Bucks", -1, 17005, 1);
		addHoveredButton(17005, 259, 146, 37, 9454);
		addText(17006, "</col>LozzCity Bucks: @gre@1,000", Rum, 0, 0xF7AA25, true, true);
		addText(17015, "", Rum, 0, 0xF7AA25, true, true);
		addHoverButton(47267, 21, 16, 16, "Close", -1, 47268, 1);
		addHoveredButton(47268, 22, 16, 16, 47269);
		addText(17008, "Mystery Box is a gambling minigame where you can bet 1 LozzCity Buck.", Rum, 0, 0xF7AA25, true, true);
		addText(17009, "Rewards can vary from items worth @gre@1,000</col> - @gre@100,000,000</col> coins!", Rum, 0, 0xF7AA25, true, true);
		addText(17010, "Good luck, may the odds be ever in your favor.", Rum, 0, 0xF7AA25, true, true);
		addHoverText(17011, "Visit online store", "@red@Donate to LozzCity!", Rum, 0, 0xF7AA25, false, true, 168);
		
		addText(17012, "Play", Rum, 2, 0xF7AA25, true, true);
	 ...
	 * @param Rum
	 */
	public static void genie(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(59500);
		addSprite(59501, 249);
		addText(59502, "Reset Statistics", 0xff9933, true, true, -1, Rum, 2);
		...
		addText(59527, "Attack", 0xff9933, true, true, -1, Rum, 0);
		addText(59528, "Strength ", 0xff9933, true, true, -1, Rum, 0);
		addText(59529, "Defence", 0xff9933, true, true, -1, Rum, 0);
		addText(59530, "Range", 0xff9933, true, true, -1, Rum, 0);
		addText(59531, "Magic", 0xff9933, true, true, -1, Rum, 0);
		addText(59532, "Prayer", 0xff9933, true, true, -1, Rum, 0);
		addText(59533, "Hitpoints", 0xff9933, true, true, -1, Rum, 0);
		addText(59534, "Please select the statistic you would like to reset.", 0xff9953, true, true, -1, Rum, 0);
	 ...
	 * @param Rum
	 */
	public static void barrows(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(59000);
		addTransparentSprite(59001, 248);
		addText(59002, "Barrows Brothers", 0xff9933, true, true, -1, Rum, 2);
		addText(59003, "Ahrim the Blighted", 0xff9933, true, true, -1, Rum, 1);
		addText(59004, "Dharok the Wretched", 0xff9933, true, true, -1, Rum, 1);
		addText(59005, "Guthan the Infested", 0xff9933, true, true, -1, Rum, 1);
		addText(59006, "Karil the Tainted", 0xff9933, true, true, -1, Rum, 1);
		addText(59007, "Torag the Corrupted", 0xff9933, true, true, -1, Rum, 1);
		addText(59008, "Verac the Defiled", 0xff9933, true, true, -1, Rum, 1);
		tab.totalChildren(8);
	 ...
	 * @param Rum
	 */
	public static void priceChecker(TextDrawingArea[] Rum) {
		...
		addText(48511, "Price Checker", Rum, 2, 0xFF981F, true, true);
		addText(48512, "Total price:", Rum, 1, 0xFF981F, true, true);
		addText(48513, "115,424,152", Rum, 0, 0xffffff, true, true);
		addText(48550, "", Rum, 0, 0xffffff, true, true);
		addText(48551, "", Rum, 0, 0xffffff, true, true);
		addText(48552, "", Rum, 0, 0xffffff, true, true);
		addText(48553, "", Rum, 0, 0xffffff, true, true);
		addText(48554, "", Rum, 0, 0xffffff, true, true);
		addText(48555, "", Rum, 0, 0xffffff, true, true);
		addText(48556, "", Rum, 0, 0xffffff, true, true);
		addText(48557, "", Rum, 0, 0xffffff, true, true);
		addText(48558, "", Rum, 0, 0xffffff, true, true);
		addText(48559, "", Rum, 0, 0xffffff, true, true);
		addText(48560, "", Rum, 0, 0xffffff, true, true);
		addText(48561, "", Rum, 0, 0xffffff, true, true);
		addText(48562, "", Rum, 0, 0xffffff, true, true);
		addText(48563, "", Rum, 0, 0xffffff, true, true);
		addText(48564, "", Rum, 0, 0xffffff, true, true);
		addText(48565, "", Rum, 0, 0xffffff, true, true);
		addText(48566, "", Rum, 0, 0xffffff, true, true);
		addText(48567, "", Rum, 0, 0xffffff, true, true);
		addText(48568, "", Rum, 0, 0xffffff, true, true);
		addText(48569, "", Rum, 0, 0xffffff, true, true);
		addText(48570, "", Rum, 0, 0xffffff, true, true);
		addText(48571, "", Rum, 0, 0xffffff, true, true);
		addText(48572, "", Rum, 0, 0xffffff, true, true);
		addText(48573, "", Rum, 0, 0xffffff, true, true);
		addText(48574, "", Rum, 0, 0xffffff, true, true);
		addText(48575, "", Rum, 0, 0xffffff, true, true);
		addText(48576, "", Rum, 0, 0xffffff, true, true);
		addText(48577, "", Rum, 0, 0xffffff, true, true);
	 ...
	 * @param Rum
	 */
	public static void itemsOnDeath(TextDrawingArea[] Rum) {
		...
		addText(17103, "Items Kept on Death", Rum, 2, 0xff981f);
		addText(17104, "Items you keep on death if not skulled:", Rum, 0, 0xff981f);
		addText(17105, "Items you lose on death if not skulled:", Rum, 0, 0xff981f);
		addText(17106, "Information:", Rum, 1, 0xff981f);
		addText(17107, "Max Items Kept on death:", Rum, 1, 0xff981f);
		addText(17108, "~ 3 ~", Rum, 1, 0xffcc33);
	 ...
	 * @param Rum
	 */
	public static void creditsTab(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(52500);
		addSprite(52501, 38);
		addText(52502, "LozzCity Shops", 0xff9933, true, true, -1, Rum, 2);
		addSprite(52503, 55);
		addText(52504, "Current LozzCity Bucks:", 0xff9933, true, true, -1, Rum, 0);
		addHoverText(52505, "Visit online store", "@red@Donate to LozzCity!", Rum, 0, 0xF7AA25, true, true, 168);
		addSprite(52506, 56);
		tab.totalChildren(9);
		...
		for (int i = 0; i < 30; i++) {
			addHoverText(52531 + i, "", "Open shop", Rum, 0, 0xE3A724, true, true, 168, 0xFFFFFF);
	 ...
	 * @param Rum
	 */
	public static void shopExchange(TextDrawingArea[] Rum) {
		RSInterface tab = addInterface(53500);
		addSprite(53501, 43);
		addHoverButton(53502, 17, 21, 21, "Close", 250, 53503, 3);
		addHoveredButton(53503, 18, 21, 21, 53504);
		addText(53505, "Shops Exchange", 0xff9933, true, true, -1, Rum, 2);
		addHoverButton(53506, 44, 45, 45, "Search", 0, 53507, 1);
		addHoveredButton(53507, 45, 45, 45, 53508);
		addText(53509, "Shop Owner:", 0xff9933, true, true, -1, Rum, 2);
		addText(53510, "Shop Description:", 0xff9933, true, true, -1, Rum, 2);
		tab.totalChildren(9);
		...
		int y = 0;
		for (int i = 0; i < 200; i++) {
			addHoverText(53516 + i, "Name: " + i, "View", Rum, 0, 0xcc8000, false, true, 100, 0xFFFFFF);
			setBounds(53516 + i, 0, y, i, scrollInterface);
			y += 20;
		}
		y = 0;
		for (int i = 0; i < 200; i++) {
			addHoverText(53516 + 200 + i, "Motto: " + i, "View", Rum, 0, 0xcc8000, false, true, 100, 0xFFFFFF);
	 ...
	 * @param Rum
	 */
	/*private static void achievementsTab(TextDrawingArea[] Rum) {
		RSInterface tab = addTabInterface(31000);
		addSprite(31001, 15);
		addText(31002, "Achievements", 0xff9040, false, true, 52, Rum, 2);
		setChildren(5, tab);
		...
		int y = 5;
		for (int i = 0; i < 80; i++) {
			addHoverText(31006 + i, "", "View", Rum, 0, 0xff0000, false, true, 300);
	...
	/*public static void questTab(TextDrawingArea[] Mayhem) {
		...
		addSprite(29401, 82);
		addSprite(29402, 38);
		addText(29403, "LozzCity", Mayhem, 2, 0xF7AA25, true, true);
		addText(29407, "www.LozzCity.com", Mayhem, 2, 0xF7AA25, true, true);
