...
//			BufferedImage image = ImageIO.read(new URL("http://www.LozzCity.com/Media/icon.png"));
...
//				trayIcon.displayMessage(ClientConstants.CLIENT_NAME, "LozzCity client has been started!", MessageType.INFO);
//			}
//		}
	}
	...
	public final void keyPressed(KeyEvent keyevent) {
		...
		if((keyevent.isControlDown() && keyevent.getKeyCode() == KeyEvent.VK_V)) {
				    	Client.instance.inputString += Client.getClipboardContents();
				    	Client.inputTaken = true;
				    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd != null) {
			...
			if (cmd.equalsIgnoreCase("Forums")) {
				Client.instance.launchURL("www.LozzCity.com/forum");
			} else if (cmd.equalsIgnoreCase("Vote")) {
				Client.instance.launchURL("www.LozzCity.com/vote/");
			} else if (cmd.equalsIgnoreCase("Store")) {
				Client.instance.launchURL("www.LozzCity.com/store/");
			} else if (cmd.equalsIgnoreCase("Highscores")) {
				Client.instance.launchURL("www.LozzCity.com/hiscores/");
			} else if (cmd.equalsIgnoreCase("Guides")) {
				Client.instance.launchURL("http://lozzcity.com/forum/index.php?/forum/17-lozzcity-guides/");
			}
		}
	}
}