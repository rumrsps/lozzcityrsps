...
public class Skill {
	...
	private double getExperienceMultiplyer(int skillId) {
		...
		case 0://Attack
			...
			if (player.getEquipment().contains(13108)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13109)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(13110)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13111)) {
				multiplyer *= 1.20;
			}
		case 1://Defence
			if (player.getEquipment().contains(4202)) {
		...
		case 5://Prayer
			...
			if (player.getEquipment().contains(13118)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(13119)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13120)) {
				multiplyer *= 1.20;
			}
			break;
		...
		case 10://Fishing
			...
			if (player.getEquipment().contains(13131)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13132)) {
				multiplyer *= 1.20;
			}
			break;
		...
		case 12://Crafting
			...
			if (player.getEquipment().contains(13134)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(13135)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13136)) {
				multiplyer *= 1.20;
			}
			break;
		...
		case 14://Mining
			...
			if (player.getEquipment().contains(11138)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(11140)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13103)) {
				multiplyer *= 1.20;
			}
			break;
		...
		case 17://Thieving
			...
			if (player.getEquipment().contains(13122)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(13123)) {
				multiplyer *= 1.15;
			}
		...
		case 19://Farming
			...
			if (player.getEquipment().contains(13126)) {
				multiplyer *= 1.10;
			}
			if (player.getEquipment().contains(13127)) {
				multiplyer *= 1.15;
			}
			if (player.getEquipment().contains(13128)) {
				multiplyer *= 1.20;
			}
			break;
		...
		return World.getEventManager().getEvent() instanceof DoubleExperience ? multiplyer * 2 : multiplyer;
	}
	...
	public double addExperience(int id, double experience) {
		...
		if (player.isExtreme())
		{
		experience = experience * Skills.EXPERIENCE_RATES[id] * 1.0D/8;
		}
		else
		{
