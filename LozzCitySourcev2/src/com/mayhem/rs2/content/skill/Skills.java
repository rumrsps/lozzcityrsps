...
public class Skills {
	...
	public static void declare() {
		...
		EXPERIENCE_RATES[PRAYER] = 150;
		EXPERIENCE_RATES[MAGIC] = 1;
		EXPERIENCE_RATES[COOKING] = 150;
		EXPERIENCE_RATES[WOODCUTTING] = 150;
		EXPERIENCE_RATES[FLETCHING] = 150;
		EXPERIENCE_RATES[FISHING] = 150;
		EXPERIENCE_RATES[FIREMAKING] = 150;
		EXPERIENCE_RATES[CRAFTING] = 150;
		EXPERIENCE_RATES[SMITHING] = 150;
		EXPERIENCE_RATES[MINING] = 150;
		EXPERIENCE_RATES[HERBLORE] = 150;
		EXPERIENCE_RATES[AGILITY] = 150;
		EXPERIENCE_RATES[THIEVING] = 150;
		EXPERIENCE_RATES[SLAYER] = 150;
		EXPERIENCE_RATES[HUNTER] = 150;
		EXPERIENCE_RATES[FARMING] = 150;
		EXPERIENCE_RATES[RUNECRAFTING] = 150;
		EXPERIENCE_RATES[DUNGEONEERING] = 150;
		EXPERIENCE_RATES[SUMMONING] = 150;
	}
