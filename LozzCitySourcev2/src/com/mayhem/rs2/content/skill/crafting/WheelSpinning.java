...
public class WheelSpinning extends ProductionTask {
	...
	public String getInsufficentLevelMessage() {
		return "You need a " + com.mayhem.rs2.content.skill.Skills.SKILL_NAMES[getSkill()] + " level of " + getRequiredLevel() + " to spin " + GameDefinitionLoader.getItemDef(spinnable.getOutcome().getId()).getName().toLowerCase() + ".";
	}
