	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, NPC_ID, Emotion.DEFAULT,
					...
					"on LozzCity. For the right price, in LozzCity Bucks, I can",
