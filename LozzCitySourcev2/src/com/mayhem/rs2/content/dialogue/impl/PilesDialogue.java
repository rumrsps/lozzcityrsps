...
public class PilesDialogue extends Dialogue {
	 ...
	 */
	public int ITEMS[][] = { { 3142, 3144 }, { 451, 452 }, { 11934, 11935 }, { 440, 441 }, { 453, 454 }, { 444, 445 }, { 447, 448 }, { 449, 450 }, { 1515, 1516 }, { 1513, 1514 } };
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, 13, Emotion.HAPPY, "I can note any items obtained from the resource", "arena for 100 coins an item.");
			next++;
			break;
		case 1:
