	...
	public boolean clickButton(int button) {
		...
		case DialogueConstants.OPTIONS_3_2:
			if (player.getCredits() < 10) {
				DialogueManager.sendStatement(player, "You do not have enough LozzCity Bucks to do this!");
				return false;
			}
		...
		case DialogueConstants.OPTIONS_5_2:
			DialogueManager.sendOption(player, "Edit shop", "Edit shop motto (10 LozzCity Bucks)", "Edit shop color (10 LozzCity Bucks)");
			return true;
