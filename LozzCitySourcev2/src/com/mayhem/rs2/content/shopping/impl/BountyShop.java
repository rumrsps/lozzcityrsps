 ...
 */
public BountyShop() {
	super(SHOP_ID, new Item[] { new Item(4151), new Item(6585), new Item(6570), new Item(11802), new Item(11804), new Item(11806), new Item(11808), new Item(12004), new Item(20784), new Item(10551), new Item(11840), new Item(12783), new Item(12759), new Item(12761), new Item(12763), new Item(12757), new Item(12771),new Item(12769), new Item(12798), new Item(12800), new Item(12802), new Item(12804), new Item(4740), new Item(892), new Item(13111), new Item(12846), new Item(12855), new Item(12856), new Item(12786), new Item(11907), new Item(553), new Item(12954), new Item(12849), new Item(12853) 
	}, false, "Bounty Store");
}
