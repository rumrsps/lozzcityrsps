	...
	public static boolean handle(Player player, int button) {
		...
		case 115012:
			if (player.getTabType() == TabType.PANELS) {
				...
				//player.send(new SendURL("http://www.LozzCity.com/store/"));
		...
		case 115013:
			if (player.getTabType() == TabType.PANELS) {
				...
				//player.send(new SendURL("http://www.LozzCity.com/forum/"));
		...
		case 115015:
			if (player.getTabType() == TabType.PANELS) {
				...
				//player.send(new SendURL("http://www.LozzCity.com"));
		...
		case 115016:
			if (player.getTabType() == TabType.PANELS) {
				...
				player.send(new SendString(Constants.DONATOR_INFO, 12000));
			}
			break;
		...
		case 115019:
			if (player.getTabType() == TabType.PANELS) {
				...
				//player.send(new SendString("<col=800000>LozzCity-OS Recent Updates", 37103));
