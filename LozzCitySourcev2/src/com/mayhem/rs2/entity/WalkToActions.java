...
public class WalkToActions {
	 ...
	 */
	//public final static String[] DEFAULT_DIALOGUES = { "When you feel sad, just sing Roar - by Katy Perry!", "Thank the LozzCity gods for this beautiful day!", "Break free of your cage and be happy!", "Porn is the key to a happy marriage.", "I'm in the mood to groove it out!", "Don't let fear hold you down.", "Just let it out, let it out.", "Make your dreams a reality.", "Be your own creator.", "Rum blesses your soul." };
	...
	public static void clickObject(final Player player, final int option, final int id, final int x, final int y) {
		...
		if (player.getDueling().isDueling()) {
			player.getDueling().clickForfeitTrapDoor(player.getIndex());
		}
	...
	public static final void finishClickNpc(Player player, int option, Mob mob) {
		...
		case 1:// NPC FIRST CLICK
			...
			case 7477:// elite platinum shop
				...
				player.getClient().queueOutgoingPacket(new SendMessage("@blu@ You have " + player.Platinum + " Platinum."));
				break;
			case 6746:// ClueShop
		...
		case 2:// NPC SECOND CLICK
			...
			case 5787:// Agility
				...
				break;
			case 7042:// Swagster
				player.start(new OptionDialogue("LozzCity Bucks Store 1", p -> {
					player.getShopping().open(94);
				} , "LozzCity Bucks Store 2", p -> {
					player.getShopping().open(90);
				} , "LozzCity Bucks Store 3", p -> {
			...
			case 306:// tutorial npc
				...
				} , "Server tour(Show several areas around LozzCity)", p -> {
	...
	public static void finishObjectClick(Player player, int id, int option, int x, int y) {
		...
		case 1:
			...
			if (id == 8720 || id == 26820 || id == 26813) {
				player.send(new SendString("http://www.LozzCity.com/vote/", 12000));
