...
public class ObjectManager {
	...
	public static void declare() {
		...
		deleteAndRemoveClip(1635, 3683, 0);
		...
		deleteWithObject(3098, 3512, 0);
		deleteWithObject(3097, 3512, 0);
		deleteWithObject(3096, 3512, 0);
		deleteWithObject(3095, 3512, 0);
		deleteWithObject(3093, 3512, 0);
		deleteWithObject(3091, 3512, 0);
		deleteWithObject(3100, 3511, 0);
		deleteWithObject(3099, 3511, 0);
		deleteWithObject(3098, 3511, 0);
		deleteWithObject(3097, 3511, 0);
		deleteWithObject(3096, 3511, 0);
		deleteWithObject(3095, 3511, 0);
		deleteWithObject(3093, 3511, 0);
		deleteWithObject(3091, 3511, 0);
		deleteWithObject(3100, 3510, 0);
		deleteWithObject(3099, 3510, 0);
		deleteWithObject(3098, 3510, 0);
		deleteWithObject(3097, 3510, 0);
		deleteWithObject(3096, 3510, 0);
		deleteWithObject(3095, 3510, 0);
		deleteWithObject(3093, 3510, 0);
		deleteWithObject(3091, 3510, 0);
		deleteWithObject(3100, 3509, 0);
		deleteWithObject(3099, 3509, 0);
		deleteWithObject(3098, 3509, 0);
		deleteWithObject(3097, 3509, 0);
		deleteWithObject(3096, 3509, 0);
		deleteWithObject(3095, 3509, 0);
		deleteWithObject(3093, 3509, 0);
		deleteWithObject(3091, 3509, 0);
		deleteWithObject(3100, 3508, 0);
		deleteWithObject(3099, 3508, 0);
		deleteWithObject(3098, 3508, 0);
		deleteWithObject(3097, 3508, 0);
		deleteWithObject(3096, 3508, 0);
		deleteWithObject(3095, 3508, 0);
		deleteWithObject(3093, 3508, 0);
		deleteWithObject(3091, 3508, 0);
		deleteWithObject(3100, 3507, 0);
		deleteWithObject(3099, 3507, 0);
		deleteWithObject(3098, 3507, 0);
		deleteWithObject(3097, 3507, 0);
		deleteWithObject(3096, 3507, 0);
		deleteWithObject(3095, 3507, 0);
		deleteWithObject(3093, 3507, 0);
		deleteWithObject(3091, 3507, 0);
		
		//3092,3094,3514,3513,3506,3505,3507
		deleteAndRemoveClip(3092, 3506, 0);
		deleteAndRemoveClip(3094, 3506, 0);
		deleteAndRemoveClip(3092, 3505, 0);
		deleteAndRemoveClip(3094, 3505, 0);
		deleteAndRemoveClip(3092, 3507, 0);
		deleteAndRemoveClip(3094, 3507, 0);
		deleteAndRemoveClip(3092, 3513, 0);
		deleteAndRemoveClip(3094, 3513, 0);
		deleteAndRemoveClip(3092, 3514, 0);
		deleteAndRemoveClip(3094, 3514, 0);
		//3092,3094,3514,3513,3506,3505,3507
				deleteWithObject(3092, 3506, 0);
				deleteWithObject(3094, 3506, 0);
				deleteWithObject(3092, 3505, 0);
				deleteWithObject(3094, 3505, 0);
				deleteWithObject(3092, 3507, 0);
				deleteWithObject(3094, 3507, 0);
				deleteWithObject(3092, 3513, 0);
				deleteWithObject(3094, 3513, 0);
				deleteWithObject(3092, 3514, 0);
				deleteWithObject(3094, 3514, 0);
		//edgevillemenho
		deleteAndRemoveClip(3092, 3506, 0);
		deleteAndRemoveClip(3093, 3506, 0);
		deleteAndRemoveClip(3094, 3506, 0);
		deleteAndRemoveClip(3092, 3507, 0);
		deleteAndRemoveClip(3093, 3507, 0);
		deleteAndRemoveClip(3094, 3507, 0);
		deleteAndRemoveClip(3092, 3506, 0);
		deleteAndRemoveClip(3093, 3506, 0);
		deleteAndRemoveClip(3094, 3506, 0);
		deleteAndRemoveClip(3092, 3514, 0);
		deleteAndRemoveClip(3093, 3514, 0);
		deleteAndRemoveClip(3094, 3514, 0);
		deleteAndRemoveClip(3092, 3513, 0);
		deleteAndRemoveClip(3093, 3513, 0);
		deleteAndRemoveClip(3094, 3513, 0);
		deleteAndRemoveClip(3092, 3505, 0);
		deleteAndRemoveClip(3093, 3505, 0);
		deleteAndRemoveClip(3094, 3505, 0);
		//edgevillemenhouseobject
		deleteWithObject(3092, 3506, 0);
		deleteWithObject(3093, 3506, 0);
		deleteWithObject(3094, 3506, 0);
		deleteWithObject(3092, 3507, 0);
		deleteWithObject(3093, 3507, 0);
		deleteWithObject(3094, 3507, 0);
		...
		deleteWithObject(3094, 3506, 0);
		deleteWithObject(3092, 3514, 0);
		deleteWithObject(3093, 3514, 0);
		deleteWithObject(3094, 3514, 0);
		deleteWithObject(3092, 3513, 0);
		deleteWithObject(3093, 3513, 0);
		deleteWithObject(3094, 3513, 0);
		deleteWithObject(3092, 3505, 0);
		deleteWithObject(3093, 3505, 0);
		deleteWithObject(3094, 3505, 0);
		...
		deleteAndRemoveClip(3091, 3495, 0);
