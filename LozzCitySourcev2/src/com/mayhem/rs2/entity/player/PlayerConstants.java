...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "rum", "", "", "" };
	 ...
	 * Home teleport
	 */
	public static Location HOME = new Location(1629, 3673, 0);
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("rum") || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("rum") || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("");
	}
