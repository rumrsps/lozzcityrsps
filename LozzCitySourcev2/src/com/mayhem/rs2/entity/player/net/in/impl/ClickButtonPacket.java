...
public class ClickButtonPacket extends IncomingPacket {
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		if ((player.getController().equals(RingOfStone.RINGOFSTONE_CONTROLLER)) && (buttonId == 23132)) {
			RingOfStone.cancel(player);
			return;
		}
		...
		case 66108:
			...
			break;
		case 66115:
			player.send(new SendString("http://www.LozzCity.com/store", 12000));
			break;
