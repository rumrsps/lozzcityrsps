...
public class Donation implements Runnable {
	...
	public static final String HOST = "www.LozzCity-ps.com";
		...
		try {
			...
			while (rs.next()) {
				...
				case 18: // 100 LozzCity bucks
					...
					player.getClient().queueOutgoingPacket(new SendMessage("Thank you for supporting LozzCity."));
					World.sendGlobalMessage("</col>[ @dre@LozzCity </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to LozzCity! Thank you for your contribution! ");
				break;
				case 19: // 300 LozzCity bucks
			...
			//		player.setMoneySpent(player.getMoneySpent() + (int)paid);
				...
				case 50: // mystery box x10
					...
					World.sendGlobalMessage("</col>[ @dre@LozzCity </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to LozzCity! Thank you for your contribution! ");
						...
						RankHandler.upgrade(player);
						player.setMember(true);
						player.getClient().queueOutgoingPacket(new SendMessage("Thank you for supporting LozzCity. Your donation has been sent to your bank."));
					}
				break;
